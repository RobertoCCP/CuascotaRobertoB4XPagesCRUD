...
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","95242882",RemoteObject.createImmutable("Index too large"),0);};
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","95308418",RemoteObject.createImmutable("Index too large"),0);};
