...
tienda.myClass = BA.getDeviceClass ("b4a.example.tienda");
tiendas.myClass = BA.getDeviceClass ("b4a.example.tiendas");
b4xtiendas.myClass = BA.getDeviceClass ("b4a.example.b4xtiendas");
videojuego.myClass = BA.getDeviceClass ("b4a.example.videojuego");
videojuegos.myClass = BA.getDeviceClass ("b4a.example.videojuegos");
b4xvideojuegos.myClass = BA.getDeviceClass ("b4a.example.b4xvideojuegos");
